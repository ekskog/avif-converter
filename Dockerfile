...
# Build libvips from official release tarball (includes configure)
ENV VIPSVERSION=8.15.2
RUN curl -fL -o vips.tar.gz https://github.com/libvips/libvips/releases/download/v${VIPSVERSION}/vips-${VIPSVERSION}.tar.gz && \
  tar -xzf vips.tar.gz && cd vips-${VIPSVERSION} && \
